...
class StudentsListTest extends TestCase
{
    ...
    public function test_Get(): void
    {
        $student = new Student();
        $studentsList = new StudentsList();
        $student->setName("Вячеслав")->setLastName("Гераськин")->setFaculty("ФМиИТ")->setCourse(4)->setGroup(402);
        $studentsList->add($student);
    ...
    public function test_CurrentAndKey(): void
    {
        ...
        $studentsList = new StudentsList();
        $student1->setName("Вячеслав")->setLastName("Гераськин")->setFaculty("ФМиИТ")->setCourse(4)->setGroup(402);
